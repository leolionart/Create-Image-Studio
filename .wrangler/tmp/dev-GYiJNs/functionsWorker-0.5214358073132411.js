...
// .wrangler/tmp/bundle-Wma5Zs/checked-fetch.js
...
// .wrangler/tmp/pages-32M872/functionsWorker-0.5214358073132411.mjs
...
var getApiKey = /* @__PURE__ */ __name2((env) => {
  return env.GEMINI_API_KEY || env.VITE_GEMINI_API_KEY;
}, "getApiKey");
var parseRequest = /* @__PURE__ */ __name2(async (request) => {
  try {
...
var sendJson = /* @__PURE__ */ __name2((body, status = 200) => {
  return new Response(JSON.stringify(body), {
    status,
    headers: JSON_HEADERS
  });
}, "sendJson");
var handleEditImage = /* @__PURE__ */ __name2(async (payload, apiKey) => {
...
var handleGenerateImage = /* @__PURE__ */ __name2(async (payload, apiKey) => {
  if (!payload.prompt) {
...
// .wrangler/tmp/bundle-Wma5Zs/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Wma5Zs/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.5214358073132411.js.map
